...
from tasks_manager import TasksManager  # Real-time transcription
...
class StreamRecorder:
    ...
    def setup_new_meeting(self):
        ...
        self.meeting_analyzer = TasksManager(self.full_recording_path,self.output_dir)  # Initialize the transcription handler with the full file
    ...
    def monitor_and_record(self):
        ...
        while True:
            ...
            try:
                while True:
                    ...
                    if not audio_chunk:
                        ...
                        if silence_counter >= self.silence_timeout:
                            ...
                            break  # ✅ Exit loop and finalize recording outside
                    ...
                    if self.recording_started:
                        ...
                        # ✅ Keep original chunk processing logic
                ...
                if self.recording_started:  # ✅ Finalize the recording outside the loop
                    print("Meeting ended, saving recording...")
                    if wav_file:
                        wav_file.close()
                    ...
                    if file_size > 1024 * 100:
                        self.meeting_analyzer.stop_transcription()
